...
<form method="GET" action="garbage_bin_edit">
	<div class="form-row">
		...
		<div class="col-sm-5">
			<input type="text" name="new_name" class="form-control ml-2 mb-2" placeholder="New name" value={{ $name }}>
		</div>
		<div class="col-sm-5">
			<input type="number" name="max_capacity" class="form-control ml-2" placeholder="New maximum Capacity" value={{ $max_capacity }}>
		</div>
		<div class="col-sm-5">
			<input type="number" name="cur_capacity" class="form-control ml-2 mb-2" placeholder="New current Capacity" value={{ $cur_capacity }} required>
		</div>
	</div>
	<div class="form-row">
		<input type="submit" name="submit" value="Submit" class="btn btn-primary ml-3">
